...
class ImageMagnifier extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      cssStyle: {
        // 图片容器样式
        imgContainer: {
          width: props.currentSliderSize.width || '400px',
          height: props.currentSliderSize.height || '400px',
        ...
        magnifierContainer: {
          position: 'absolute',
          left: props.magnifierContainerLeft
            ? props.magnifierContainerLeft - 40 + 16 + 'px'
            : '400px',
          top: '0',
          width: '510px',
          height: '510px',
  ...
  // 更新图片
  updataImg(props) {
    let magnifierContainerLeft = props.magnifierContainerLeft - 40 + 16;
    console.info('magnifierContainerLeft', magnifierContainerLeft);
    let newCssStyle = {
      ...this.state.cssStyle,
      magnifierContainer: {
        position: 'absolute',
        left: (magnifierContainerLeft || '400') + 'px',
        top: '0',
        width: '510px',
        height: '510px',
        border: '1px solid #ccc',
    ...
    console.info('props.currentSliderSize', props.currentSliderSize);
    this.setState({
    ...
    return (
      <div>
        <div style={cssStyle.imgContainer}>
          <img style={cssStyle.imgStyle} src={minImg} alt="minimg" />
          <div
